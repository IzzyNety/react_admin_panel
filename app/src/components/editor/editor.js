...
export default class Editor extends Component {
    ...
    open(page, cb) {
        ...
        axios
            ...
            .then(() => this.iframe.load("../hjasdifhi23__rejah2.html"))
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm("Вы действительно хотите восстановить страницу из этой резервной копии? Все несохраненные данные будут потеряны!", {labels: {ok: 'Востановить', cancel: 'Отмена'}})
        .then(() => {
            this.isLoading();
            return axios
